...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Essentials
\name{Siddhanathan}{Shanmugam}
\address{Philadelphia, PA 19104}
\mobile{+please (email) for-details} 
%%% Social
\email{ss3774@drexel.edu}
\homepage{siddhanathan.github.io}
\github{siddhanathan}
% \linkedin{posquit0}
%%% Optionals
\position{Student{\enskip\cdotp\enskip}Computer Science}
